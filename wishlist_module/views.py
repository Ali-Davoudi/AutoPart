...
from wishlist_module.models import UserWishList, UserWishListDetail
...
def user_wishlist(request: HttpRequest):
    ...
    return render(request, 'wishlist_module/WishList.html', context)
...
def site_header_wishlist_count(request: HttpRequest):
    ...
    return render(request, 'wishlist_module/components/SiteHeaderWishListCountPartial.html', context)
...
def remove_favourite_product(request: HttpRequest):
    ...
    return JsonResponse({
        'status': 'success',
        'body': render_to_string('wishlist_module/WishList.html', context)
    })
