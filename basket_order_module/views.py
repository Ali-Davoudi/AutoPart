...
def site_header_order_count(request: HttpRequest):
    ...
    return render(request, 'basket_order_module/components/SiteHeaderOrderCountPartial.html', context)
...
def site_header_mini_cart(request: HttpRequest):
    ...
    return render(request, 'basket_order_module/components/SiteHeaderMiniCartPartial.html', context)
...
def user_basket_order(request: HttpRequest):
    ...
    return render(request, 'basket_order_module/UserBasket.html', context)
...
def remove_an_order(request: HttpRequest):
    ...
    return JsonResponse({
        'status': 'success',
        'body': render_to_string('basket_order_module/UserBasket.html', context)
    })
