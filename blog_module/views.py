...
class BlogListView(ListView):
    template_name = 'blog_module/BlogList.html'
    model = Blog
...
def blog_categories_component(request: HttpRequest):
    ...
    return render(request, 'blog_module/components/BlogCategory.html', context)
...
def blog_tags_component(request: HttpRequest):
    ...
    return render(request, 'blog_module/components/BlogTag.html', context)
...
def last_blogs_component(request: HttpRequest):
    ...
    return render(request, 'blog_module/components/LastBlogs.html', context)


# Details of eatch blog
class BlogDetailView(DetailView):
    template_name = 'blog_module/BlogDetail.html'
    model = Blog
...
# Add comment for eatch blog detail
class AddBlogComment(View):
    def post(self, request: HttpRequest):
        ...
        return render(request, 'blog_module/components/BlogCommentPartial.html', context)
